        ...
        self.assertEqual(
            ...
            [
                Error(
                    (
                        "The model is used as an intermediate model by"
                        " 'invalid_models_tests.Person.friends', but it has more than"
                        " two foreign keys to 'Person', which is ambiguous. You must"
                        " specify which two foreign keys Django should use via the"
                        " through_fields keyword argument."
                    ),
                    hint=(
    ...
    def test_foreign_key_to_non_unique_field(self):
        ...
        self.assertEqual(
            ...
            [
                Error(
                    (
                        "'Target.bad' must be unique because it is referenced by a"
                        " foreign key."
                    ),
                    hint=(
            ...
            [
                Error(
                    (
                        ...
                        " names of the two link fields that should be used for the"
                        " relation through model 'invalid_models_tests.Invitation'."
                    ),
                    hint=(
