...
GLOSSARY = {
    ...
    "PROD": (
        "Product, i.e. artificially produced entities including speeches, radio shows,"
        " programming languages, contracts, laws and ideas"
    ),
    "DRV": (
        "Words (and phrases?) that are dervied from a name, but not a name in"
        " themselves, e.g. 'Oslo-mannen' ('the man from Oslo')"
    ),
    "GPE_LOC": (
        "Geo-political entity, with a locative sense, e.g. 'John lives in Spain'"
    ),
    "GPE_ORG": (
        "Geo-political entity, with an organisation sense, e.g. 'Spain declined to meet"
        " with Belgium'"
    ),
}
