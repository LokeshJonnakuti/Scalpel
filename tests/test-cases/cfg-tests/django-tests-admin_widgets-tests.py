...
class ForeignKeyRawIdWidgetTest(TestCase):
    ...
    def test_proper_manager_for_label_lookup(self):
        ...
        self.assertHTMLEqual(
            ...
            ' href="/admin_widgets/inventory/?_to_field=barcode" class="related-lookup"'
            ' id="lookup_id_test" title="Lookup"></a>&nbsp;<strong><a'
            ' href="/admin_widgets/inventory/%(pk)s/change/">Hidden</a></strong>'
            % {"pk": hidden.pk},
        )
    ...
    def test_render_unsafe_limit_choices_to(self):
        ...
        self.assertHTMLEqual(
            ...
            (
                ...
                ' href="/admin_widgets/band/?name=%22%26%3E%3Cescapeme&amp;_to_field=artist_ptr"'
                ' class="related-lookup" id="lookup_id_test" title="Lookup"></a>'
            ),
        )
...
class ManyToManyRawIdWidgetTest(TestCase):
    def test_render(self):
        ...
        self.assertHTMLEqual(
            ...
            ' class="vManyToManyRawIdAdminField"><a href="/admin_widgets/member/"'
            ' class="related-lookup" id="lookup_id_test" title="Lookup"></a>'
