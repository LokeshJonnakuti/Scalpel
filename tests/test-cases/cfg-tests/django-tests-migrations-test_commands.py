    ...
    def test_showmigrations_plan(self):
        ...
        self.assertEqual(
            (
                "[ ]  migrations.0001_initial\n[ ]  migrations.0003_third ..."
                " (migrations.0001_initial)\n[ ]  migrations.0002_second ..."
                " (migrations.0001_initial, migrations.0003_third)\n"
            ),
            out.getvalue().lower(),
        )
...
class SquashMigrationsTests(MigrationTestBase):
    ...
    def test_squashmigrations_squashes(self):
        ...
        self.assertEqual(
            ...
            " 0002_second\nOptimizing...\n  Optimized from 8 operations to 2"
            " operations.\nCreated new squashed migration %s\n  You should commit this"
            " migration but leave the old ones in place;\n  the new migration will be"
            " used for new installs. Once you are sure\n  all instances of the codebase"
            " have applied the migrations you squashed,\n  you can delete them.\n"
