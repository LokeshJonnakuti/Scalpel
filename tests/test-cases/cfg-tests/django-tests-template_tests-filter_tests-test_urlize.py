...
class UrlizeTests(SimpleTestCase):
    ...
    def test_urlize01(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                ' href="http://example.com?x=&amp;y=%3C2%3E"'
                ' rel="nofollow">http://example.com?x=&amp;y=&lt;2&gt;</a>'
            ),
        )
    ...
    def test_urlize02(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                ' rel="nofollow">http://example.com?x=&amp;y=</a>'
            ),
        )
    ...
    def test_urlize09(self):
        ...
        self.assertEqual(
            output,
            (
                '<a href="http://example.com/?x=&amp;y=%3C2%3E"'
                ' rel="nofollow">http://example.com/?x=&amp;y=&lt;2&gt;</a>'
            ),
        )
...
class FunctionTests(SimpleTestCase):
    ...
    def test_url_split_chars(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                ' rel="nofollow">www.server.com</a>&quot;abc'
            ),
        )
        self.assertEqual(
            urlize("www.server.com'abc"),
    ...
    def test_trailing_period(self):
        ...
        self.assertEqual(
            ...
            (
                '(Go to <a href="http://www.example.com/foo"'
                ' rel="nofollow">http://www.example.com/foo</a>.)'
            ),
        )
    ...
    def test_trailing_multiple_punctuation(self):
        self.assertEqual(
            ...
            (
                'A test <a href="http://testing.com/example"'
                ' rel="nofollow">http://testing.com/example</a>..'
            ),
        )
        self.assertEqual(
            urlize("A test http://testing.com/example!!"),
    ...
    def test_brackets(self):
        ...
        self.assertEqual(
            ...
            (
                'see <a href="http://test[at[example.com"'
                ' rel="nofollow">test[at[example.com</a>'
            ),
        )
        self.assertEqual(
        ...
        for wrapping_in, (start_out, end_out) in wrapping_chars:
            with self.subTest(wrapping_in=wrapping_in):
                ...
                self.assertEqual(
                    ...
                    ' rel="nofollow">https://www.example.org/</a>'
                    + end_out,
                )
    ...
    def test_ipv4(self):
        self.assertEqual(
            ...
            (
                '<a href="http://192.168.0.15/api/9"'
                ' rel="nofollow">http://192.168.0.15/api/9</a>'
            ),
        )
    ...
    def test_ipv6(self):
        self.assertEqual(
            ...
            (
                '<a href="http://[2001:db8:cafe::2]/api/9"'
                ' rel="nofollow">http://[2001:db8:cafe::2]/api/9</a>'
            ),
        )
    ...
    def test_exclamation_marks(self):
        ...
        self.assertEqual(
            ...
            (
                'Go to <a href="http://djangoproject.com"'
                ' rel="nofollow">djangoproject.com</a>! and enjoy.'
            ),
        )
        self.assertEqual(
            urlize("Search for google.com/?q=! and see."),
            (
                'Search for <a href="http://google.com/?q="'
                ' rel="nofollow">google.com/?q=</a>! and see.'
            ),
        )
        self.assertEqual(
            urlize("Search for google.com/?q=dj!`? and see."),
            (
                'Search for <a href="http://google.com/?q=dj%21%60%3F"'
                ' rel="nofollow">google.com/?q=dj!`?</a> and see.'
            ),
        )
        self.assertEqual(
            urlize("Search for google.com/?q=dj!`?! and see."),
