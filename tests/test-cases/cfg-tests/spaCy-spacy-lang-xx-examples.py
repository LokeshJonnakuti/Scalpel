...
sentences = [
    ...
    (
        "Apple está buscando comprar una startup del Reino Unido por mil millones de"
        " dólares."
    ),
    ...
    (
        "Les voitures autonomes déplacent la responsabilité de l'assurance vers les"
        " constructeurs"
    ),
    ...
    (
        "Le automobili a guida autonoma spostano la responsabilità assicurativa verso i"
        " produttori"
    ),
    ...
    (
        "Kto ma ochotę zapoznać się z innymi niż w książkach przygodami Muminków i ich"
        " przyjaciół, temu polecam komiks Tove Jansson „Muminki i morze”."
    ),
    (
        "Apple está querendo comprar uma startup do Reino Unido por 100 milhões de"
        " dólares."
    ),
    (
    ...
    (
        "Apple рассматривает возможность покупки стартапа из Соединённого Королевства"
        " за $1 млрд"
    ),
    "Беспилотные автомобили перекладывают страховую ответственность на производителя",
    (
        "В Сан-Франциско рассматривается возможность запрета роботов-курьеров, которые"
        " перемещаются по тротуару"
    ),
    "Лондон — это большой город в Соединённом Королевстве",
    # Native Russian sentences:
    # Colloquial:
    "Да, нет, наверное!",  # Typical polite refusal
    (  # From a tour guide speech
        "Обратите внимание на необыкновенную красоту этого города-героя Москвы, столицы"
        " нашей Родины!"
    ),
    ...
    (
        "Уж коли я, такой же, как и ты, человек грешный, над тобой умилился и пожалел"
    ...
    (
        "Зато всегда так происходило, что чем более я ненавидел людей в частности, тем"
        " пламеннее становилась любовь моя к человечеству вообще"
    ),
    # Quotes from Chekhov:
    (
        "Ненужные дела и разговоры всё об одном отхватывают на свою долю лучшую часть"
        " времени, лучшие силы, и в конце концов остается какая-то куцая, бескрылая"
        " жизнь, какая-то чепуха, и уйти и бежать нельзя, точно сидишь в сумасшедшем"
        " доме или в арестантских ротах!"
    ),
    # Quotes from Turgenev:
    (
        "Нравится тебе женщина, старайся добиться толку; а нельзя — ну, не надо,"
        " отвернись — земля не клином сошлась"
    ),
    (
        "Узенькое местечко, которое я занимаю, до того крохотно в сравнении с остальным"
        " пространством, где меня нет и где дела до меня нет; и часть времени, которую"
        " мне удастся прожить, так ничтожна перед вечностью, где меня не было и не"
        " будет..."
    ),
    # Quotes from newspapers:
    # Komsomolskaya Pravda:
    (
        "На заседании президиума правительства Москвы принято решение присвоить статус"
        " инвестиционного приоритетного проекта города Москвы киностудии Союзмультфильм"
    ),
    (
        "Глава Минобороны Сергей Шойгу заявил, что обстановка на этом стратегическом"
        " направлении требует непрерывного совершенствования боевого состава войск"
    ),
    # Argumenty i Facty:
    (
        "На реплику лже-Говина — дескать, он (Волков) будет лучшим революционером —"
        " Стамп с энтузиазмом ответил: Непременно!"
    ),
]
