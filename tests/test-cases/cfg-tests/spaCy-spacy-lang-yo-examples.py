...
sentences = [
    ...
    (
        "Olúṣẹ́gun Ọbásanjọ́, tí ó jẹ́ Ààrẹ ìjọba ológun àná (láti ọdún 1976 sí 1979),"
        " tí ó sì tún ṣe  Ààrẹ ìjọba alágbádá tí ìbò gbé wọlé (ní ọdún 1999 sí 2007),"
        " kúndùn láti máa bu ẹnu àtẹ́ lu àwọn ètò ìjọba Ààrẹ orílẹ̀-èdè Nàìjíríà tí ó"
        " jẹ tẹ̀lé e."
    ),
    ...
    (
        "Bi a se n so, omobinrin ni oruko ni ojo kejo bee naa ni omokunrin ni oruko ni"
        " ojo kesan."
    ),
