...
class HeadersCheckMixin:
    def assertMessageHasHeaders(self, message, headers):
        ...
        self.assertTrue(
            ...
            msg="Message is missing the following headers: %s"
            % (headers - msg_headers),
        )
    ...
    def test_space_continuation(self):
        ...
        email = EmailMessage(
            (
                ...
                " continuation character to get expected behavior in Outlook and"
                " Thunderbird"
            ),
            "Content",
            "from@example.com",
        ...
        self.assertEqual(
            ...
            (
                b"Long subject lines that get wrapped should contain a space"
                b" continuation\n character to get expected behavior in Outlook and"
                b" Thunderbird"
            ),
        )
