    ...
    def test_unicode_values(self):
        ...
        self.assertHTMLEqual(
            ...
            (
                ...
                ' type="text" name="first_name" value="John" id="id_first_name"'
                ' required></td></tr>\n<tr><th><label for="id_last_name">Last'
                ' name:</label></th><td><input type="text" name="last_name"'
                ' value="\u0160\u0110\u0106\u017d\u0107\u017e\u0161\u0111"id="id_last_name"'
                " required></td></tr>\n<tr><th><label"
                ' for="id_birthday">Birthday:</label></th><td><input type="text"'
                ' name="birthday" value="1940-10-9" id="id_birthday"'
                " required></td></tr>"
            ),
        )
        self.assertHTMLEqual(
            p.as_ul(),
            (
                '<li><label for="id_first_name">First name:</label> <input type="text"'
                ' name="first_name" value="John" id="id_first_name"'
                ' required></li>\n<li><label for="id_last_name">Last name:</label>'
                ' <input type="text" name="last_name"'
                ' value="\u0160\u0110\u0106\u017d\u0107\u017e\u0161\u0111"'
                ' id="id_last_name" required></li>\n<li><label'
                ' for="id_birthday">Birthday:</label> <input type="text"'
                ' name="birthday" value="1940-10-9" id="id_birthday" required></li>'
            ),
        )
        self.assertHTMLEqual(
            p.as_p(),
            (
                ...
                ' for="id_birthday">Birthday:</label> <input type="text"'
                ' name="birthday" value="1940-10-9" id="id_birthday" required></p>'
            ),
        )
...
Java</label></li>
        ...
        t = Template(
            '{% for radio in form.language %}<div class="myradio">{{ radio }}</div>{%'
            " endfor %}"
        )
        self.assertHTMLEqual(
...
<input type="hidden" name="composers" value="J">""",
        ...
        self.assertHTMLEqual(
            ...
            (
                ...
                ' required><input type="text" name="when_1" value="01:01"'
                ' id="id_when_1" required>'
            ),
        )
        self.assertHTMLEqual(
            f["when"].as_hidden(),
...
<li><label><input checked type="checkbox" name="composers" value="P"> Paul McCartney</label></li>
        ...
        t = Template(
            '{% for checkbox in form.composers %}<div class="mycheckbox">{{ checkbox'
            " }}</div>{% endfor %}"
        )
        self.assertHTMLEqual(
            t.render(Context({"form": f})),
...
<li>Secret answer = <input type="text" name="answer" required></li>""",
        ...
        self.assertHTMLEqual(
            f.as_ul(),
            (
                '<li>Favorite color? <input type="text" name="color"'
                ' required></li>\n<li>Favorite animal\u2192 <input type="text"'
                ' name="animal" required></li>\n<li>Secret answer = <input type="text"'
                ' name="answer" required></li>'
            ),
        )
...
<option value="false" selected>No</option>
    ...
    def test_forms_with_file_fields(self):
        ...
        self.assertHTMLEqual(
            f.as_table(),
            (
                '<tr><th>File1:</th><td><input type="file" name="file1"'
                " required></td></tr>"
            ),
        )
...
<input type="submit" required>
        ...
        self.assertEqual(
            ...
            (
                "VALID: [('password1', 'secret'), ('password2', 'secret'), ('username',"
                " 'adrian')]"
            ),
        )
...
<input type="submit" required>
    ...
    def test_hidden_initial_gets_id(self):
        ...
        self.assertHTMLEqual(
            MyForm().as_table(),
            (
                '<tr><th><label for="id_field1">Field1:</label></th><td><input'
                ' id="id_field1" type="text" name="field1" maxlength="50"'
                ' required><input type="hidden" name="initial-field1"'
                ' id="initial-id_field1"></td></tr>'
            ),
        )
...
<input type="number" name="age" id="id_age" required></td></tr>""",
    ...
    def test_field_name_with_hidden_input_and_non_matching_row_ender(self):
        ...
        self.assertHTMLEqual(
            form.as_p(),
            (
                '<p><input id="id_custom" name="custom" type="text" required>'
                ' custom</p>\n<input id="id_hidden1" name="hidden1"'
                ' type="hidden"><input id="id_hidden2" name="hidden2"'
                ' type="hidden"><hr><hr>'
            ),
        )
    ...
    def test_error_dict(self):
        ...
        control = [
            ...
            (
                '<li>__all__<ul class="errorlist nonfield"><li>Non-field'
                " error.</li></ul></li>"
            ),
        ]
        for error in control:
...
<p>Comment: <input type="text" name="comment" required></p>""",
    ...
    def test_error_escaping(self):
        ...
        self.assertHTMLEqual(
            form.as_ul(),
            (
                '<li><ul class="errorlist nonfield"><li>(Hidden field hidden) Foo &amp;'
                ' &quot;bar&quot;!</li></ul></li><li><ul class="errorlist"><li>Foo'
                " &amp; &quot;bar&quot;!</li></ul><label"
                ' for="id_visible">Visible:</label> <input type="text" name="visible"'
                ' value="b" id="id_visible" required><input type="hidden" name="hidden"'
                ' value="a" id="id_hidden"></li>'
            ),
        )
    ...
    def test_use_required_attribute_true(self):
        ...
        self.assertHTMLEqual(
            form.as_p(),
            (
                '<p><label for="id_f1">F1:</label> <input id="id_f1" maxlength="30"'
                ' name="f1" type="text" required></p><p><label for="id_f2">F2:</label>'
                ' <input id="id_f2" maxlength="30" name="f2" type="text"></p><p><label'
                ' for="id_f3">F3:</label> <textarea cols="40" id="id_f3" name="f3"'
                ' rows="10" required></textarea></p><p><label for="id_f4">F4:</label>'
                ' <select id="id_f4" name="f4"><option value="P">Python</option><option'
                ' value="J">Java</option></select></p>'
            ),
        )
        self.assertHTMLEqual(
            form.as_ul(),
            (
                '<li><label for="id_f1">F1:</label> <input id="id_f1" maxlength="30"'
                ' name="f1" type="text" required></li><li><label'
                ' for="id_f2">F2:</label> <input id="id_f2" maxlength="30" name="f2"'
                ' type="text"></li><li><label for="id_f3">F3:</label> <textarea'
                ' cols="40" id="id_f3" name="f3" rows="10"'
                ' required></textarea></li><li><label for="id_f4">F4:</label> <select'
                ' id="id_f4" name="f4"><option value="P">Python</option><option'
                ' value="J">Java</option></select></li>'
            ),
        )
        self.assertHTMLEqual(
            form.as_table(),
            (
                '<tr><th><label for="id_f1">F1:</label></th><td><input id="id_f1"'
                ' maxlength="30" name="f1" type="text"'
                " required></td></tr><tr><th><label"
                ' for="id_f2">F2:</label></th><td><input id="id_f2" maxlength="30"'
                ' name="f2" type="text"></td></tr><tr><th><label'
                ' for="id_f3">F3:</label></th><td><textarea cols="40" id="id_f3"'
                ' name="f3" rows="10" required></textarea></td></tr><tr><th><label'
                ' for="id_f4">F4:</label></th><td><select id="id_f4" name="f4"><option'
                ' value="P">Python</option><option'
                ' value="J">Java</option></select></td></tr>'
            ),
        )
    ...
    def test_use_required_attribute_false(self):
        ...
        self.assertHTMLEqual(
            ...
            (
                '<p><label for="id_f1">F1:</label> <input id="id_f1" maxlength="30"'
                ' name="f1" type="text"></p><p><label for="id_f2">F2:</label> <input'
                ' id="id_f2" maxlength="30" name="f2" type="text"></p><p><label'
                ' for="id_f3">F3:</label> <textarea cols="40" id="id_f3" name="f3"'
                ' rows="10"></textarea></p><p><label for="id_f4">F4:</label> <select'
                ' id="id_f4" name="f4"><option value="P">Python</option><option'
                ' value="J">Java</option></select></p>'
            ),
        )
        self.assertHTMLEqual(
            ...
            (
                '<li><label for="id_f1">F1:</label> <input id="id_f1" maxlength="30"'
                ' name="f1" type="text"></li><li><label for="id_f2">F2:</label> <input'
                ' id="id_f2" maxlength="30" name="f2" type="text"></li><li><label'
                ' for="id_f3">F3:</label> <textarea cols="40" id="id_f3" name="f3"'
                ' rows="10"></textarea></li><li><label for="id_f4">F4:</label> <select'
                ' id="id_f4" name="f4"><option value="P">Python</option><option'
                ' value="J">Java</option></select></li>'
            ),
        )
        self.assertHTMLEqual(
            ...
            (
                '<tr><th><label for="id_f1">F1:</label></th><td><input id="id_f1"'
                ' maxlength="30" name="f1" type="text"></td></tr><tr><th><label'
                ' for="id_f2">F2:</label></th><td><input id="id_f2" maxlength="30"'
                ' name="f2" type="text"></td></tr><tr><th><label'
                ' for="id_f3">F3:</label></th><td><textarea cols="40" id="id_f3"'
                ' name="f3" rows="10"></textarea></td></tr><tr><th><label'
                ' for="id_f4">F4:</label></th><td><select id="id_f4" name="f4"><option'
                ' value="P">Python</option><option'
                ' value="J">Java</option></select></td></tr>'
            ),
