...
class FormattingTests(SimpleTestCase):
    ...
    def test_l10n_enabled(self):
        ...
        with translation.override("ru", deactivate=True):
            self.assertHTMLEqual(
                (
                    '<select name="mydate_day" id="id_mydate_day"><option'
                    ...
                    ' value="30">30</option><option value="31"'
                    ' selected>31</option></select><select name="mydate_month"'
                    ' id="id_mydate_month"><option value="">---</option><option'
                    ' value="1">\u042f\u043d\u0432\u0430\u0440\u044c</option><option'
                    ' value="2">\u0424\u0435\u0432\u0440\u0430\u043b\u044c</option><option'
                    ' value="3">\u041c\u0430\u0440\u0442</option><option'
                    ' value="4">\u0410\u043f\u0440\u0435\u043b\u044c</option><option'
                    ' value="5">\u041c\u0430\u0439</option><option'
                    ' value="6">\u0418\u044e\u043d\u044c</option><option'
                    ' value="7">\u0418\u044e\u043b\u044c</option><option'
                    ' value="8">\u0410\u0432\u0433\u0443\u0441\u0442</option><option'
                    ' value="9">\u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c</option><option'
                    ' value="10">\u041e\u043a\u0442\u044f\u0431\u0440\u044c</option><option'
                    ' value="11">\u041d\u043e\u044f\u0431\u0440\u044c</option><option'
                    ' value="12"'
                    " selected>\u0414\u0435\u043a\u0430\u0431\u0440\u044c</option></select><select"
                    ' name="mydate_year" id="id_mydate_year"><option'
                    ' value="">---</option><option value="2009"'
                    ' selected>2009</option><option value="2010">2010</option><option'
    ...
    def test_localized_input(self):
        ...
        with translation.override("de-at", deactivate=True):
            ...
            self.assertHTMLEqual(
                form6.as_ul(),
                (
                    '<li><label for="id_name">Name:</label><input id="id_name"'
                    ' type="text" name="name" value="acme" maxlength="50"'
                    ' required></li><li><label for="id_date_added">Date'
                    ' added:</label><input type="text" name="date_added"'
                    ' value="31.12.2009 06:00:00" id="id_date_added"'
                    ' required></li><li><label for="id_cents_paid">Cents'
                    ' paid:</label><input type="text" name="cents_paid" value="59,47"'
                    ' id="id_cents_paid" required></li><li><label'
                    ' for="id_products_delivered">Products delivered:</label><input'
                    ' type="text" name="products_delivered" value="12000"'
                    ' id="id_products_delivered" required></li>'
                ),
            )
            self.assertEqual(
        ...
        with self.settings(FORMAT_MODULE_PATH="i18n.other.locale"):
            with translation.override("de", deactivate=True):
                ...
                self.assertEqual(
                    ...
                    old,
                    (
                        "Value returned by get_formats_modules() must be preserved"
                        " between calls."
                    ),
                )
    ...
    def test_localize_templatetag_and_filter(self):
        ...
        template1 = Template(
            "{% load l10n %}{% localize %}{{ int }}/{{ float }}/{{ date }}{%"
            " endlocalize %}; {% localize on %}{{ int }}/{{ float }}/{{ date }}{%"
            " endlocalize %}"
        )
        template2 = Template(
    ...
    def test_localized_as_text_as_hidden_input(self):
        ...
        with translation.override("de-at", deactivate=True):
            ...
            template_as_text = Template(
                "{% load l10n %}{{ form.date_added.as_text }}; {{"
                " form.cents_paid.as_text }}"
            )
            template_as_hidden = Template(
                "{% load l10n %}{{ form.date_added.as_hidden }}; {{"
                " form.cents_paid.as_hidden }}"
            )
            form = CompanyForm(
                {
                    "name": "acme",
            ...
            self.assertHTMLEqual(
                ...
                (
                    ...
                    ' value="31.12.2009 06:00:00" required>;<input id="id_cents_paid"'
                    ' name="cents_paid" type="text" value="59,47" required>'
                ),
            )
            self.assertHTMLEqual(
            ...
            self.assertHTMLEqual(
                ...
                (
                    ...
                    ' value="31.12.2009 06:00:00">;<input id="id_cents_paid"'
